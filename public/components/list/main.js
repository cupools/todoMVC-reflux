...
function bindEvent() {
    ...
    $('#list_wrap .weui_btn').on('click', function() {
...
function render(payload) {
    if(payload.status) {
        $('#list_wrap .weui_btn').removeClass('weui_btn_primary').addClass('weui_btn_warn').text('删除');
    } else {
        $('#list_wrap .weui_btn').removeClass('weui_btn_warn').addClass('weui_btn_primary').text('完成');
    }
    if(payload.list.length < 1) {
        $('#list_wrap .weui_btn').hide();
    }  else {
        $('#list_wrap .weui_btn').show();
    }
